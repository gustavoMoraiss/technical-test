package com.training.interviewtechnicaltest.features.pullrequest.presentation.components
...
fun PullRequestItem(
    ...
    OutlinedCard(
        ...
        Row(
            ...
            AsyncAvatarImage(
                dataUrl = pullRequest?.head?.user?.avatarUrl.orEmpty(),
                modifier = Modifier
            ...
            Column(modifier = Modifier.padding(12.dp)) {
                Text(
                    text = pullRequest?.title.orEmpty(),
